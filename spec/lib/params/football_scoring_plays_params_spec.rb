...
module Stattleship
  module Params
    RSpec.describe FootballScoringPlaysParams do
      describe '#query' do
        it 'defines a query hash of all parameters' do
          params = FootballScoringPlaysParams.new
        ...
        it 'constructs only the given game parameter' do
          ...
          params.game_id = 'nfl-2015-2016-ne-den-2015-10-27-1900'

          query_parameters = params.query['query']

          expect(query_parameters.size).to eq 1
          expect(query_parameters['game_id']).to eq 'nfl-2015-2016-ne-den-2015-10-27-1900'
        end
